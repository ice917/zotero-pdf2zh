...
class TranslationSettings(BaseModel):
    ...
    working_dir: str | None = Field(
        default=None,
        description="Directory to keep intermediate working files in. When set, "
        "files such as translate_tracking.json are written to "
        "<working_dir>/<input stem> and are never deleted automatically. "
        "When not set, a temporary directory is used unless debug is enabled.",
    )
