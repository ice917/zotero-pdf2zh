...
MIRRORS = {
    ...
    "pdfminer_pdfinterp.py": os.path.join(VENV_SITE, "pdfminer", "pdfinterp.py"),
    ...
    "server_utils_execute.py": os.path.join(REPO, "server", "utils", "execute.py"),
    "server_utils_task_manager.py": os.path.join(REPO, "server", "utils", "task_manager.py"),
}
